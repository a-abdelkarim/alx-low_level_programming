...
void printElfEntryPointAddress(Elf64_Ehdr *header);
...
int main(int argc, char **argv)
{
    ...
    printElfMagic(&header);
    printElfClass(&header);
    printElfData(&header);
    printElfVersion(header.e_ident[EI_VERSION]);
    printElfOsAbi(&header);
    printElfType(&header);
    printElfEntryPointAddress(&header);
